---
title: HjjMate Introduction — Self-hosted Multi-Agent AI Operating System
description: HjjMate is an open-source multi-agent AI OS built on Spring AI Alibaba. ReAct + Plan-and-Execute engines, LLM Wiki knowledge base, 4-layer memory lifecycle, MCP tool protocol, 8-channel integration. One self-hosted JAR with operator-controlled data and outbound integrations.
head:
  - - meta
    - name: keywords
      content: HjjMate,multi-agent AI,self-hosted AI,AI operating system,Spring AI Alibaba,ReAct,Plan-and-Execute,MCP,LLM Wiki,memory lifecycle,Tool Guard,open source
---

# HjjMate — Self-hosted Multi-Agent AI Operating System

**Your multi-agent AI. On your hardware. Under your rules.**

HjjMate is a full AI operating system you deploy yourself. One JAR. One login. You control persisted data and outbound integrations.
...
HjjMate fights a different fight. It's **all of it, under one roof, on hardware you control.**
...
Running HjjMate on your own hardware is not a compliance checkbox. It changes what the product **is**.
...
**You own the roadmap.** Don't like how the memory consolidator works? Change it. Need a tool your vendor won't build? Add it. HjjMate is Apache 2.0 — not source-available, not "open core", not waiting on a quarterly product review.
