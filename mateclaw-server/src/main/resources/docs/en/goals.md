...
description: HjjMate's Goal system lets a digital worker lock a multi-turn task as a goal, self-evaluate progress, and optionally drive itself forward until done or out of budget.
head:
  - - meta
    - name: keywords
      content: Goal,Agent,multi-turn,auto-evaluation,auto-followup,persistent,HjjMate
---
