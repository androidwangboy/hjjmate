export default {
  ...
  chat: {
    ...
    selectAgent: 'Please select an expert',
    ...
    loadAgentsFailed: 'Failed to load experts',
    ...
    filterByAgent: 'Filter by expert',
    allAgents: 'All experts',
    pin: 'Pin',
    unpin: 'Unpin',
    rename: 'Rename',
  ...
  plans: {
    title: 'Plan Board',
    subtitle: "Lay out an expert's plans and steps as a board by status",
    selectAgent: 'Select an expert',
    allEmployees: 'All experts',
    unknownAgent: 'Unknown expert',
    noPlansAll: 'No plans across the team yet. Once a plan-execute expert runs a multi-step task, it shows up here.',
    detail: 'Plan detail',
    assignee: 'Assignee',
    progress: 'Progress',
    created: 'Created',
    ...
    plans: 'Plans',
    noPlans: 'No plans for this expert yet',
    noAgent: 'Select an expert to begin',
  ...
  live: {
    kicker: 'Live',
    title: 'See what your experts are doing',
    attention: 'Someone needs your attention',
    unknownAgent: 'Expert',
    aTool: 'a tool',
    orphan: 'no one watching',
    orphanHint: 'The browser tab closed but this expert is still working.',
    ...
    headline: {
      ...
      working: 'Your {n} experts are at work.',
    ...
    confirm: {
      stopTitle: 'Stop this expert?',
      stopBody: 'Ask {name} to wind down. The current step will finish first.',
      endTitle: 'Force {name} to stop now?',
      endBody: 'This will stop the expert immediately. Any work in progress will be lost. The user will see "stopped by admin".',
      subTitle: 'Stop this helper?',
      subBody: 'Stop {name}. The owning expert will keep running.',
      sweepTitle: 'Tidy up stuck experts?',
      sweepBody: '{n} expert(s) look stuck. Stop all of them now?',
    },
    toast: {
      stopped: 'Asked it to stop.',
      ended: 'Stopped.',
      subStopped: 'Helper stopped.',
      swept: 'Tidied up {n} expert(s).',
    },
    empty: {
      allQuiet: 'All quiet.',
      hint: 'No experts are working right now. This page will light up when one is.',
    },
    time: {
      justNow: 'just now',
      seconds: '{n}s',
  ...
  settings: {
    ...
    migration: {
      title: 'Data Migration (Export / Import)',
      desc: 'Package experts, teams, skills, knowledge bases, workflows and triggers into an environment-independent .mcbundle. Import only adds — it never overwrites existing data.',
      safetyTitle: 'Non-destructive guarantees',
      safety1: 'Import only inserts rows; it never updates or deletes what already exists',
      safety2: 'No overwrite mode: a name clash with different content is imported as "xxx (imported)"',
      safety3: 'Every import gets a batch id you can revert with one click (only that batch is removed)',
      exportTitle: 'Export',
      exportHint: 'Pick the modules to export, or a single expert (its dependencies come along).',
      modAgents: 'Experts',
      modTeams: 'Teams',
      modSkills: 'Skills',
      modKbs: 'Knowledge bases',
      modWorkflows: 'Workflows',
      modTriggers: 'Triggers',
      pickAgents: 'Export a single expert',
      pickAgentsHint: 'Leave empty to export everything; dependencies are included automatically.',
      allAgents: 'All experts',
      includeKb: 'Include knowledge-base source material (wiki pages regenerate after import)',
      includePages: 'Include generated wiki pages (larger bundle, no regeneration wait after import)',
      includeMemory: "Include expert memory files (AGENTS / MEMORY / PROFILE / KNOWLEDGE, not SOUL)",
      importScopeHint: 'Scope follows the bundle: pages are restored if present, memory is written if present. Memory of pre-existing experts is never touched.',
      exportBtn: 'Generate bundle',
      exportOk: 'Bundle generated',
      exportFail: 'Export failed',
      importTitle: 'Import',
      importHint: 'Preview first — preview writes nothing.',
      conflictPolicy: 'Name-clash policy',
      conflictPolicyHint: 'What to do when the target has the same name but different content.',
      policyRename: 'rename: import under a new name (recommended)',
      policySkip: 'skip: keep the existing version',
      policyFail: 'fail: abort the whole import',
      pickFile: 'Click to choose or drop a .mcbundle here',
      previewBtn: 'Preview (no writes)',
      previewFail: 'Preview failed',
      importBtn: 'Commit import',
      importOk: 'Import finished',
      ...
      colDetail: 'Detail',
      batchId: 'Batch id',
      revertTitle: 'Revert an import',
      revertHint: 'Only rows created by that batch are removed; existing data is untouched.',
      revertBtn: 'Revert import',
      batchPlaceholder: 'Enter a batch id, e.g. a1b2c3d4',
      revertConfirm: 'Revert import batch {batch}? Only data created by this batch will be deleted.',
      revertOk: 'Reverted — {n} rows removed',
    ...
    model: {
      ...
      claudeCodeOauthRevokeHint: 'Sign out from the Claude Code app to revoke. HjjMate does not modify Claude Code\'s on-disk credentials.',
    ...
    hints: {
      ...
      theme: 'Switch between light / dark / system appearance. Takes effect immediately.',
    ...
    localTools: {
      desktopOnly: 'Local tools are only available inside the desktop client. Open this page in the HjjMate desktop app to manage them.',
  ...
  agents: {
    kicker: 'Expert Studio',
    title: 'Experts',
    desc: 'Hire, train, and manage your experts',
    newAgent: 'Hire Expert',
    views: {
      roster: 'Roster',
      live: 'Live',
      plans: 'Plans',
    ...
    api: {
      open: 'API Management',
      kicker: 'EXTERNAL ACCESS',
      summary: 'Publish this expert to CRM, portals, or other business systems.',
      published: 'Published',
      unpublished: 'Not published',
      keys: 'keys',
      callsToday: 'calls today',
      loading: 'Loading API status…',
      openConsole: 'Open API Console',
      hint: 'Manage keys, rate limits, docs, logs, stats, and testing in the console.',
      publishSuccess: 'API published',
      unpublishSuccess: 'API unpublished',
      updateFailed: 'Failed to update API status',
    },
    columns: {
      name: 'Name',
      description: 'Description',
    ...
    emptyDesc: 'Hire your first expert to get started',
    modal: {
      newTitle: 'New Expert',
    ...
    fields: {
      ...
      runtimeNativeHint: 'Uses HjjMate\'s native Agent Loop.',
      ...
      goal: 'Goal',
      goalHint: 'Why this expert exists — the outcome they help you reach.',
      ...
      workspaceBasePathHint: 'Optional. Set a dedicated working directory for this expert. Relative paths resolve under the workspace root; absolute paths are used as-is. Leave blank to inherit the workspace default.',
      modelName: 'Model',
      modelGlobalDefault: 'Use global default',
      modelHint: 'Override the global default model for this expert. Leave blank to follow Settings → Models.',
      tags: 'Tags',
    ...
    guide: {
      ...
      desc: "This is the expert's behavior handbook (AGENTS.md): when to write memories, what goes in each file, and which memory tools are available. The Role/Goal/Backstory above are the expert's factory identity; evolving memories like PROFILE/MEMORY live in the Memory menu.",
      empty: 'This expert has no behavior guide (AGENTS.md) yet.',
      create: 'Create Behavior Guide',
      saved: 'Saved',
      addSection: 'Add Section',
      addSectionPlaceholder: 'Section title',
      scaffold: '## When to Write Memories\n\n(Describe when this expert should record to MEMORY.md / PROFILE.md.)\n\n## File Responsibilities\n\n(Describe what belongs in SOUL.md / PROFILE.md / MEMORY.md.)\n',
    },
    thinkingLevels: {
      auto: 'Follow Model',
      off: 'Off',
    ...
    messages: {
      ...
      deleteConfirm: 'Let this expert go? This cannot be undone.',
      loadFailed: 'Failed to load experts',
      saveFailed: 'Failed to save expert',
      saveSuccess: 'Expert saved',
      deleteFailed: 'Failed to delete expert',
      tagRemoved: 'Removed tag "{tag}"',
      deleteSuccess: 'Expert let go',
    ...
    wizard: {
      entry: 'AI Create',
      kicker: 'AI Create',
      title: 'Create an expert in one sentence',
      subtitle: 'Describe the expert you need — AI configures the persona, type and tools; confirm to onboard.',
      ...
      emptyRequirement: 'Please describe the expert you need first',
      ...
      successSubtitle: 'The new expert has joined your team and is ready to chat.',
  ...
  acp: {
    ...
    env: {
      ...
      hints: {
        ...
        dashscope: 'Aliyun DashScope key — same value as HjjMate .env DASHSCOPE_API_KEY',
  ...
  datasources: {
    ...
    fields: {
      ...
      schemaName: 'Schema',
      ownerSchema: 'Owner / Schema (optional)',
      username: 'Username',
      password: 'Password',
      description: 'Description',
    ...
    placeholders: {
      ...
      port: '3306',
      databaseName: 'Database name',
      serviceName: 'Service Name, e.g. ORCL',
  ...
  wiki: {
    ...
    adv: {
      ...
      perm: {
        tab: 'Permissions',
        title: 'Expert Page Type Permissions',
        desc: 'Configure per-pageType read/create/update/delete access for an expert in this KB; writes can require approval. No rules = allow all; once any rule exists, uncovered types are fail-safe denied.',
        agent: 'Expert',
        selectAgent: 'Select an expert…',
        pageType: 'Page Type',
        policy: 'Write policy',
        noRows: 'This expert has no permission rules (allow all).',
  ...
  workflows: {
    ...
    canvas: {
      ...
      fields: {
        ...
        agentPlaceholder: 'Select digital expert',
        agentMissing: 'Current digital expert is not in the list: {name}',
    ...
    dialogs: {
      ...
      fieldName: 'Name',
      namePlaceholder: 'e.g. expert-onboarding',
  ...
  login: {
    ...
    heroDesc: 'HjjMate is not about stuffing more capability into a chat box. It is about pulling context, knowledge, execution, and memory into one reliable operating surface.',
  ...
  onboarding: {
    ...
    send: 'Send',
    startUsing: 'Start Using HjjMate',
    skip: 'Skip',
    back: 'Back',
  },
  talk: {
